function Y = chebyshev_filter(X,m,a,b,a0,DL11,DL22,DL33,DG1,DG2,DG3,S,kpt_vec,spin)
...
gamma = 2/sigma1;
% HX = H * X;
HX = h_nonlocal_vector_mult(DL11,DL22,DL33,DG1,DG2,DG3,X,S,kpt_vec,spin);
Y = (sigma1/e)*(HX-c*X);
...
while(ii <= m)
	...
	% HX = H * Y;
	HX = h_nonlocal_vector_mult(DL11,DL22,DL33,DG1,DG2,DG3,Y,S,kpt_vec,spin);
